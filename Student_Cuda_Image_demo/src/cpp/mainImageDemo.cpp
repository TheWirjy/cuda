...
int mainImageDemo(Settings& settings);
...
int mainImageDemo(Settings& settings)
    ...
    Viewer<RipplingProvider> rippling(nozoomable, 0, 25); // imageOption px py
    Viewer<MandelbrotJuliaProvider> mandelbrotJulia(zoomable, 480, 75);
    Viewer<RaytracingProvider> raytracing(nozoomable, 960, 125);
