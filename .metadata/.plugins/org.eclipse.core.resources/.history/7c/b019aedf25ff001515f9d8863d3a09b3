...
extern __global__ void mandelbrotJulia(uchar4* ptrDevPixels,uint w, uint h,float n, DomaineMath domaineMath);
...
MandelbrotJulia::MandelbrotJulia(const Grid& grid, uint w, uint h, float dt, uint n, const DomaineMath& domaineMath) :
	Animable_I<uchar4>(grid, w, h, "Mandelbrot_Julia_CUDA_RGBA_uchar4",domaineMath), variateurAnimation(Interval<int>(30, 100), dt)
    {
